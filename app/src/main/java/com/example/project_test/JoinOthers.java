...
public class JoinOthers extends AppCompatActivity {
    ...
    Toolbar toolbar;
    String getID, myName, otherName, notifName;
    ImageView backArrow;
    Handler handler;
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        String message = IDreference.child(FirebaseAuth.getInstance().getUid()).getKey().toString();
        switch (item.getItemId()) {
            case R.id.shareLink:
                Intent sharingIntent = new Intent(android.content.Intent.ACTION_SEND);
                sharingIntent.setType("text/plain");
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "User ID");
            ...
            case R.id.copyLink:
                ...
                ClipData clip = ClipData.newPlainText("User ID", message);
