...
public class EditPurchaseItem extends AppCompatActivity {
    ...
    DatabaseReference referenceToUser, referenceToUserItems, referencetoUserProfile;
        ...
        if (!isConnected(this))
            ...
            StatusDialog.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    showStatusDialog.setSingleChoiceItems(items, checkedItem, new DialogInterface.OnClickListener() {
                        @Override
                    ...
                    showStatusDialog.setNegativeButton("Set Status", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                        }
